package com.venky.flightreservation.util;
...
public class EmailUtil {
	...
	@Value("${com.venky.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached";

	@Value("${com.venky.flightreservation.itinerary.email.subject}")
